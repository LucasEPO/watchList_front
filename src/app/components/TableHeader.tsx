...
import { useTableData } from "../controllers/DashboardController";
...
const TableHeader: React.FC<TableHeaderProps> = ({ headers, columnWidths, tableTitle, dataLength, onRefresh }) => (
            ...
            <th colSpan={headers.length} className="p-4 bg-orange-400 rounded-t-3xl w-full">
                ...
                <div className="float-right">
                    <div className="inline-block mr-2 drop-shadow-2xl">
                        <ExpansiveButton icon={<FiPlus />} label="Novo Reporte" />
                    </div>
